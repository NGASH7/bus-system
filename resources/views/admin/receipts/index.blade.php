            ...
            <div class="welcome-header-minimal mb-8">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex gap-4">
                        <a href="{{ route('admin.receipts.index') }}" class="btn-filter-tab {{ $viewType == 'Manual' ? 'active' : '' }}">
                            <i class="fas fa-user-edit mr-2"></i> Manual Receipts
                        </a>
                        <a href="{{ route('admin.receipts.system') }}" class="btn-filter-tab {{ $viewType == 'System' ? 'active' : '' }}">
