<x-admin-layout>
        ...
        <div class="max-w-[1440px] mx-auto">
            ...
            <div class="welcome-header-minimal mb-8">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="page-title">{{ $viewType }} Receipt Management</h1>
                        <p class="text-sm text-gray-500 mt-1">
                            @if($viewType == 'Manual')
                                Manage invoices generated manually by administrators.
                            @else
                                Track invoices automatically generated by the rental system.
                            @endif
                        </p>
                    </div>
                    <div class="flex gap-4">
                        <a href="{{ route('admin.receipts.index') }}"
                            class="btn-filter-tab {{ $viewType == 'Manual' ? 'active' : '' }}">
                            <i class="fas fa-user-edit mr-2"></i> Manual Receipts
                        </a>
                        <a href="{{ route('admin.receipts.system') }}"
                            class="btn-filter-tab {{ $viewType == 'System' ? 'active' : '' }}">
                            <i class="fas fa-robot mr-2"></i> System Receipts
                        </a>
                    </div>
                </div>
            </div>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="6" class="empty-table-state">
                                                <div class="empty-icon-wrap"><i class="fas fa-file-invoice-dollar"></i>
                                                </div>
    ...
    <style>
        ...
        .btn-action-receipt.view {
            background: rgba(128, 0, 0, 0.05);
            color: var(--maroon);
        }

        .btn-action-receipt.view:hover {
            background: var(--maroon);
            color: white;
        }
        ...
        .btn-action-receipt.edit {
            background: rgba(59, 130, 246, 0.05);
            color: #3b82f6;
        }

        .btn-action-receipt.edit:hover {
            background: #3b82f6;
            color: white;
        }

        .btn-action-receipt.delete {
            background: rgba(239, 68, 68, 0.05);
            color: #ef4444;
        }

        .btn-action-receipt.delete:hover {
            background: #ef4444;
            color: white;
        }
