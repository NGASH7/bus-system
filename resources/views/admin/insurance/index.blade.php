        ...
        <div class="insurance-container">
            ...
            <div class="page-header-premium">
                <div class="header-main">
                    <h1 class="premium-title">Fleet Insurance Management</h1>
                    <div class="header-line"></div>
                </div>
                <p class="premium-subtitle">Monitor and update insurance policies for the entire fleet.</p>
            </div>
            ...
            <div class="stats-row mt-6">
                ...
                <div class="mini-stat-card">
                    <span class="mini-label">Active Policies</span>
                    <span class="mini-value text-green">{{ $buses->where('insurance_status', 'ok')->count() }}</span>
                </div>
                <div class="mini-stat-card">
                ...
                <div class="mini-stat-card">
                    ...
                    <span class="mini-value text-red">{{ $buses->where('insurance_status', 'expired')->count() }}</span>
                </div>
            </div>
            ...
            <div class="premium-card mt-8">
                <div class="card-header-flex">
                    <h3 class="card-title">Fleet Insurance Status</h3>
                </div>
                        ...
                        <tbody>
                            @forelse($buses as $bus)
                                <tr>
                                    ...
                                    <td>
                                        <span class="status-badge {{ $bus->insurance_status }}">
                                            {{ ucfirst($bus->insurance_status) }}
                                        </span>
                                    </td>
                                    <td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="7" class="text-center py-8">No buses found in the system.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
