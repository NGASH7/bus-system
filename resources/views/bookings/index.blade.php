                                        ...
                                        <div class="action-content">
                                            ...
                                            @if($booking->payment_status !== 'paid')
                                                <div class="pay-now-card mt-4">
                                                    ...
                                                    <p class="pay-now-subtitle">
                                                        ...
                                                        <strong>KES
                                                            {{ number_format($booking->counter_price ?: $booking->offered_price ?: $booking->amount, 0) }}</strong>
                                                    </p>
                                                    <form method="POST" action="{{ route('bookings.pay', $booking->id) }}">
                                                        @csrf
                                                        <div class="pay-grid">
                                                            <select name="payment_method" class="pay-input payment-method-select"
                                                                data-booking="{{ $booking->id }}" required>
                                                            ...
                                                            <div class="mpesa-phone-wrap" id="mpesa-phone-wrap-{{ $booking->id }}"
                                                                style="display:none;">
                                            ...
                                            @else
                                                <div class="payment-status-paid mt-4">
                                                    ...
                                                    Payment
                                                    completed{{ $booking->payment_method ? ' via ' . $booking->payment_method : '' }}.
                                    ...
                                    @if($booking->bus && $booking->bus->driver)
                                        <div class="driver-contact-pill">
                                            <div class="driver-avatar-sm">
                                                {{ strtoupper(substr($booking->bus->driver->name, 0, 1)) }}
                                            </div>
